...
public class GameTest {
    ...
    Logs logs=new Logs("ftext.txt");
    Game_Server game = new Game_Server (false,socket);
    ...
    /*
     * Dado que hay que tener la imagen (en este caso el cliente) encendido para ir respondiendo,
    ...
    public void secret_test() throws IOException, NoSuchAlgorithmException, MalformedString {
        ...
        //game.mandarSecreto(); //equivalente a:
        game.mandarSecreto();
        String s=protocolo.convertirByteStr();
